...
function Sidebar() {
  ...
  return (
    ...
    <div class="menu">
        ...
        <a>
        <HeadsetIcon /> 
            <span class="menu--item--text">Discover</span>
        </a>
        ...
        { /*eslint-disable-next-line*/}
            <a>
                <SearchIcon /> <span class="menu--item--text">Search</span>
            </a>
        </div>
        <div class="menu--item">
        { /*eslint-disable-next-line*/}
            <a>
                <FavoriteIcon/> <span class="menu--item--text">Favourites</span>
            </a>
        </div>
        <div class="menu--item">
       { /*eslint-disable-next-line*/}
            <a>
                <PlayCircleFilledIcon/> <span class="menu--item--text">Playlist</span>
            </a>
        </div>
        <div class="menu--item">
        { /*eslint-disable-next-line*/}
            <a>
                <HorizontalSplitIcon/> <span class="menu--item--text">Charts</span>
            </a>
        </div>
    </div>
</nav>
