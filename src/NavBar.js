...
function Sidebar() {
  ...
  return (
    ...
    <div className="menu">
        ...
        { /*eslint-disable-next-line*/}
            <a>
                <SearchIcon /> <span className="menu--item--text">Search</span>
            </a>
        </div>
        <div className="menu--item">
        { /*eslint-disable-next-line*/}
            <a>
                <FavoriteIcon/> <span className="menu--item--text">Favourites</span>
            </a>
        </div>
        <div className="menu--item">
       { /*eslint-disable-next-line*/}
            <a>
                <PlayCircleFilledIcon/> <span className="menu--item--text">Playlist</span>
            </a>
        </div>
        <div className="menu--item">
        { /*eslint-disable-next-line*/}
            <a>
                <HorizontalSplitIcon/> <span className="menu--item--text">Charts</span>
            </a>
        </div>
    </div>
</nav>
